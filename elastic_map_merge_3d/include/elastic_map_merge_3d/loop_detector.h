...
#ifndef ELASTIC_MAP_MERGE_3D_LOOP_DETECTOR_H
#define ELASTIC_MAP_MERGE_3D_LOOP_DETECTOR_H

#include <boost/format.hpp>
#include <elastic_map_merge_3d/keyframe.h>
#include <elastic_map_merge_3d/registrations.h>
...
//   typedef pcl::PointXYZI PointT;
   ...
   */
  std::vector<Loop::Ptr> detect(const std::vector<KeyFrame::Ptr>& keyframes, const std::deque<KeyFrame::Ptr>& new_keyframes, elastic_map_merge_3d::GraphSLAM& graph_slam) {
...
private:
  ...
  std::vector<KeyFrame::Ptr> find_candidates(const std::vector<KeyFrame::Ptr>& keyframes, const KeyFrame::Ptr& new_keyframe) const {
    ...
    for(const auto& k : keyframes) {
      ...
      // check if estimated distance between keyframes is not too small
   ...
   */
  Loop::Ptr matching(const std::vector<KeyFrame::Ptr>& candidate_keyframes, const KeyFrame::Ptr& new_keyframe, elastic_map_merge_3d::GraphSLAM& graph_slam) {
...
#endif  // ELASTIC_MAP_MERGE_3D_LOOP_DETECTOR_H
