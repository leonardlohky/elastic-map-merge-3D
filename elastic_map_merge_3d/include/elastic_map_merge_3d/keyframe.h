...
#ifndef ELASTIC_MAP_MERGE_3D_KEYFRAME_H
#define ELASTIC_MAP_MERGE_3D_KEYFRAME_H
...
public:
  ...
  KeyFrame(const ros::Time& stamp, std::string& robot_ns, const Eigen::Isometry3d& odom, double accum_distance, const pcl::PointCloud<PointT>::ConstPtr& cloud);
...
public:
  ...
  std::string robot_ns;                           // robot namespace identifier
...
#endif  // ELASTIC_MAP_MERGE_3D_KEYFRAME_H